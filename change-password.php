	...
	<section class="flex items-center py-10 bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800 ">
		...
		<div
			...
			<div class="flex flex-col justify-between">
				<div>
					<h2 class="text-4xl lg:text-5xl font-bold leading-tight">Lets Change Your Password</h2>
				</div>
			...
			<div class="">
				<form name="chngpwd" method="post" onSubmit="return valid();">
					...
					<?php } ?>
					<div>
						<span class="uppercase text-sm text-gray-600 font-bold">Current Password</span><input type="password"
							name="password"
							class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
							id="exampleInputPassword1" placeholder="Current Password" required="">
					</div>
					<div class="mt-8">
						<span class="uppercase text-sm text-gray-600 font-bold">New Password</span>
						<input type="password"
							class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
					...
					<div class="mt-8">
						<span class="uppercase text-sm text-gray-600 font-bold">Confirm Password</span>
						<input type="password"
							class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
							name="confirmpassword" id="confirmpassword" placeholder="Confrim Password" required="">
					</div>
					<div class="mt-8">
						<button type="submit" name="submit5"
							class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">Change</button>
					</div>
				</form>
