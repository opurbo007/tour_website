...
<section class="flex items-center py-10 bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800 ">
  ...
  <div
    ...
    <div class="">
      ...
      <address>
        <strong class="block text-lg font-semibold mb-2 lg:py-20">The Leisure Life</strong>
        <div class="mb-2">123 Main Street</div>
        <div class="mb-2">Cityville, State 12345</div>
        <div class="mb-2">Country</div>
        <br>
        <div class="mb-2">Phone: (123) 456-7890</div>
        <div>Email: <a href="mailto:info@example.com" class="text-blue-500">info@example.com</a></div>
      </address>
    </div>
  </div>
