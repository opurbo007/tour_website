...
<section class="flex items-center py-10 bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800 ">
	...
	<div
		...
		<div class="flex flex-col justify-between">
			<div>
				<h2 class="text-4xl lg:text-5xl font-bold leading-tight">Lets Submit Your Enquiry!</h2>
			</div>
		...
		<div class="">
			...
			<form name="enquiry" method="post">
				...
				<div>
					<span class="uppercase text-sm text-gray-600 font-bold">Full Name</span> <input type="text" name="fname"
						class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
						id="fname" placeholder="Full Name" required="">
				</div>
				<div class="mt-8">
					<span class="uppercase text-sm text-gray-600 font-bold">Email</span> <input type="email" name="email"
						class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
						id="email" placeholder="Valid Email id" required="">
				</div>

				<div class="mt-8">
					<span class="uppercase text-sm text-gray-600 font-bold">Mobile:</span><input type="text" name="mobileno"
						class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
						id="mobileno" maxlength="10" placeholder="10 Digit mobile No" required="">
				</div>

				<div class="mt-8">
					<span class="uppercase text-sm text-gray-600 font-bold">Subject</span> <input type="text" name="subject"
						class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
						id="subject" placeholder="Subject" required="">
				</div>
				<div class="mt-8">
					<span class="uppercase text-sm text-gray-600 font-bold">Message</span><textarea name="description"
						class="w-full h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
						rows="6" cols="50" id="description" placeholder="Description" required=""></textarea>
				</div>
				<div class="mt-8">
					<button type="submit" name="submit1"
						class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">Submit</button>
				</div>
			</form>
