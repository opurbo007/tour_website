					...
					<form name="chngpwd" method="post">
						...
						if ($query->rowCount() > 0) {
							foreach ($results as $result) { ?>
								...
								<div>
									<span class="uppercase text-sm text-gray-600 font-bold">Full Name</span><input type="text" name="name"
										value="<?php echo htmlentities($result->FullName); ?>"
										class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
										id="name" required="">
								</div>
								<div class="mt-8">
									<span class="uppercase text-sm text-gray-600 font-bold">Mobile</span>
									<input type="text"
										class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
										name="mobileno" maxlength="11" value="<?php echo htmlentities($result->MobileNumber); ?>" id="mobileno"
										required="">
								...
								<div class="mt-8">
									...
									<input type="email"
										class="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline"
										name="email" value="<?php echo htmlentities($result->EmailId); ?>" id="email" readonly>
								</div>
								<div class="mt-8">
									<span class="uppercase text-sm text-gray-600 font-bold">Last Updation Date : </span>
									<?php echo htmlentities($result->UpdationDate); ?>

								</div>
								<div class="mt-8">
									<span class="uppercase text-sm text-gray-600 font-bold">Reg Date : </span>
						...
						<div class="mt-8">
							<button type="submit" name="submit6"
								class="uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">Updtae</button>
						</div>
					</form>
